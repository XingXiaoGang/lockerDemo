...
public class SignaturePad extends View {
    ...
    private static String TAG = "test.SignaturePad";
    ...
    private static final int DOUBLE_CLICK_DELAY_MS = 500;
    ...
    private final boolean DEFAULT_ATTR_CLEAR_ON_DOUBLE_CLICK = true;
